...
// products = [
//   { name: 'Black Tee', price: 499, image: 'https://via.placeholder.com/200' },
//   { name: 'White Tee', price: 599, image: 'https://via.placeholder.com/200' },
//   { name: 'Blue Tee', price: 699, image: 'https://via.placeholder.com/200' },
//   { name: 'Red Tee', price: 799, image: 'https://via.placeholder.com/200' },
//   { name: 'Gym Tee', price: 899, image: 'https://via.placeholder.com/200' },
//   { name: 'Oversized', price: 999, image: 'https://via.placeholder.com/200' }
// ];
groupedProducts: any[] = [];
currentIndex = 0;

...
@Component({
  ...
  templateUrl: './womens-product.html',
  styleUrl: './womens-product.scss',
})
export class WomensProduct implements OnInit {
...
openProduct(product: any) {
  this.router.navigate(['/Womensproductview', product.id],{
      state: { product }}
  )
}
